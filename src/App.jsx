...
import { Users, Calendar, BarChart3, Plus, Check, X, Edit3, Trash2, Save, UserCheck, UserX, Clock, LogOut, User, Lock, Eye, EyeOff, Shield } from "lucide-react";

export default function AuthenticatedAttendanceTracker() {
  ...
  const users = {
    staff: [
      ...
      },
      {
        ...
        email: 'rajesh.sharma@psncet.edu',
        department: 'Computer Science Engineering'
      }
    ],
    student: [
  ...
  const [attendanceRecords, setAttendanceRecords] = useState([
    ...
    { id: 5, studentId: 1, date: "2024-01-16", status: "present", remarks: "" },
    { id: 6, studentId: 2, date: "2024-01-16", status: "present", remarks: "" },
    { id: 7, studentId: 3, date: "2024-01-16", status: "absent", remarks: "Family emergency" },
    { id: 8, studentId: 4, date: "2024-01-16", status: "present", remarks: "" },
  ]);
  ...
  const handleLogin = (e) => {
    ...
    const userList = users[loginForm.role];
    ...
    if (user) {
      ...
      setActiveTab(loginForm.role === 'student' ? 'my-attendance' : 'attendance');
    } else {
  ...
  const updateAttendanceStatus = (studentId, status, remarks = "") => {
    if (userRole !== 'staff') return; // Only staff can update attendance
  ...
  // Save edited student (staff only)
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center px-4">
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 w-full max-w-md border border-white/20">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/20 text-white rounded-lg px-10 py-3 placeholder-gray-400 border border-white/30 focus:border-blue-400 focus:outline-none"
                  placeholder={loginForm.role === 'staff' ? 'e.g., Dr.Suresh' : 'e.g., Udhya86,Vengat87,Vignesh88,Vinoth89'}
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/20 text-white rounded-lg px-10 pr-10 py-3 placeholder-gray-400 border border-white/30 focus:border-blue-400 focus:outline-none"
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-blue-500 to-purple-500 text-white py-3 rounded-lg font-medium hover:from-blue-600 hover:to-purple-600 transition-all"
            >
              Sign In
            </button>
          </form>
  ...
  const getNavigationItems = () => {
    if (userRole === 'staff') {
      ...
      return [
        { id: 'my-attendance', label: 'My Attendance', icon: BarChart3 },
        { id: 'calendar', label: 'Calendar View', icon: Calendar }
      ];
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 mb-8 border border-white/20">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
            <div>
              ...
              <p className="text-gray-300">{classSettings.departmentName} - {classSettings.teacher}</p>
          ...
          <nav className="flex space-x-2 overflow-x-auto">
            {getNavigationItems().map(({ id, label, icon: Icon }) => (
              <button
                ...
                className={`flex items-center px-6 py-3 rounded-xl transition-all duration-200 whitespace-nowrap ${
                  activeTab === id
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
          ...
          {activeTab === 'attendance' && userRole === 'staff' && (
          ...
          {activeTab === 'my-attendance' && userRole === 'student' && (
            <div className="space-y-6">
              ...
              <div className="bg-white/10 rounded-xl p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <h3 className="text-white font-semibold text-xl">{currentUser.name}</h3>
                      <p className="text-gray-400">Roll: {currentUser.rollNumber}</p>
                      <p className="text-gray-400 text-sm">{currentUser.email}</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-3xl font-bold text-white">{getAttendanceStats(currentUser.id).attendancePercentage}%</p>
                  ...
                  return (
                    <>
                      <div className="grid grid-cols-4 gap-4 mb-4">
                        ...
                        <div className="text-center">
                          <p className="text-2xl font-bold text-yellow-400">{stats.lateDays}</p>
              ...
              <div className="bg-white/10 rounded-xl p-6">
                <h3 className="text-white font-semibold mb-4">Recent Attendance History</h3>
                <div className="space-y-3">
                  {attendanceRecords
                    ...
                    .slice(0, 10)
                    .map(record => (
                      <div key={record.id} className="flex justify-between items-center p-4 bg-white/5 rounded-lg">
                        <div>
                          ...
                          {record.remarks && (
                            <p className="text-gray-400 text-sm">{record.remarks}</p>
                          )}
                        </div>
                        <span className={`px-3 py-1 rounded-full text-sm flex items-center space-x-1 ${getStatusColor(record.status)}`}>
          ...
          {/* Staff Students Tab */}
          {activeTab === 'students' && userRole === 'staff' && (
            <div className="space-y-6">
